...
const map: Record<string, ComponentType> = {
    ...
    'link-shortener': dynamic(() =>
        import('./link-shortener-tool').then(
            (module) => module.LinkShortenerTool,
        ),
    ),
    'json-formatter': dynamic(() =>
        import('./json-formatter-tool').then(
            (module) => module.JsonFormatterTool,
        ),
    ),
    'sql-formatter': dynamic(() =>
        import('./sql-formatter-tool').then(
            (module) => module.SqlFormatterTool,
        ),
    ),
    ...
    'markdown-viewer': dynamic(() =>
        import('./markdown-viewer-tool').then(
            (module) => module.MarkdownViewerTool,
        ),
    ),
    ...
    'pdf-compressor': dynamic(() =>
        import('./pdf-compressor-tool').then(
            (module) => module.PdfCompressorTool,
        ),
    ),
    'name-generator': dynamic(() =>
        import('./name-generator-tool').then(
            (module) => module.NameGeneratorTool,
        ),
    ),
    ...
    'remove-accents': dynamic(() =>
        import('./remove-accents-tool').then(
            (module) => module.RemoveAccentsTool,
        ),
    ),
    ...
    'add-days-to-date': dynamic(() =>
        import('./add-days-to-date-tool').then(
            (module) => module.AddDaysToDateTool,
        ),
    ),
    'subtract-dates': dynamic(() =>
        import('./subtract-dates-tool').then(
            (module) => module.SubtractDatesTool,
        ),
    ),
    'sort-dedupe-list': dynamic(() =>
        import('./sort-dedupe-list-tool').then(
            (module) => module.SortDedupeListTool,
        ),
    ),
};
