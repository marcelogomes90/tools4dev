...
export function QrCodeGeneratorTool() {
    const [text, setText] = useState(
        'https://github.com/marcelogomes90/tools4dev',
    );
    ...
    async function generateQr() {
        ...
        try {
            ...
            setQrDataUrl('');
            setError(
                'Falha ao gerar QR Code. Verifique o texto e tente novamente.',
            );
        } finally {
            setLoading(false);
        }
                ...
                <InputPanel>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            value={size}
                            onChange={(event) =>
                                setSize(Number(event.target.value || 100))
                            }
                        />
                    </div>
