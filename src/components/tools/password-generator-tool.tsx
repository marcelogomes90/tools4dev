...
import { PasswordOptions, generatePasswordBatch } from '@/lib/tools/password';
...
export function PasswordGeneratorTool() {
    ...
    const [options, setOptions] =
        useState<PasswordOptions>(createDefaultOptions);
    ...
    const generate = useCallback(() => {
        try {
            ...
            setError(
                err instanceof Error ? err.message : 'Falha ao gerar senhas.',
            );
            setResult([]);
        }
    }, [amount, options]);
                ...
                <OutputPanel>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                downloadText(resultText, 'senhas.txt')
                            }
                        >
                            Baixar
                        </Button>
