...
export const toolDefinitions: ToolDefinition[] = [
  {
    slug: 'cpf-generator',
    name: 'Gerador de CPF',
    description: 'Gera e válida CPFs com ou sem máscara.',
    category: 'Identidade',
  ...
  },
  {
    ...
    description: 'Gera e válida CNPJs com ou sem máscara.',
    category: 'Identidade',
  ...
  },
  {
    ...
    description: 'Cria links curtos locais com slug customizável opcional.',
    category: 'DevTools',
  ...
  },
  {
    ...
    description: 'Formata SQL com dialect e estilo configurável.',
    category: 'DevTools',
  ...
  },
  {
    slug: 'my-ip',
    name: 'Meu IP',
    description: 'Exibe o IP público visto pelo servidor da aplicação.',
    category: 'DevTools',
